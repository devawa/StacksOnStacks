...
public class Scanner_BTLE extends Service {
    ...
    public final static String ACTION_GATT_CONNECTED="com.example.tyler.myapplication.ACTION_GATT_CONNECTED";
    public final static String ACTION_GATT_DISCONNECTED="com.example.tyler.myapplication.ACTION_GATT_DISCONNECTED";
    public final static String ACTION_GATT_SERVICES_DISCOVERED="com.example.tyler.myapplication.ACTION_GATT_SERVICES_DISCOVERED";
    public final static String ACTION_DATA_AVAILABLE="com.example.tyler.myapplication.ACTION_DATA_AVAILABLE";
    public final static String EXTRA_DATA="com.example.tyler.myapplication.EXTRA_DATA";
