...
<nav class="cyan darken-4">
    <div class="nav-wrapper">
      ...
      <ul class="right hide-on-med-and-down">
        ...
        <li><a class="waves-effect waves-light btn nav-btn" href="homePage.php">Login<i class="fas fa-sign-in-alt"></a></li>
      </ul>
    </div>
  </nav>
  ...
  <ul class="sidenav cyan darken-4" id="mobile-demo">
    <li><a class="waves-effect waves-light btn nav-btn" href="index.php">Home</a></li>
    <li><a class="waves-effect waves-light btn nav-btn" href="homePage.php">Login<i class="fas fa-sign-in-alt"></i></a></li>
  </ul>
