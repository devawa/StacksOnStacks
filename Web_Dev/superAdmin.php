...
<head>
    ...
    <style>
        body {
            ...
            width: 100%;
            height: 100vh;
            background: url(images/superAdmin.jpg) 50% 50% no-repeat;
...
<?php $page = 'superAdmin'; include "nav-bar.php" ?>
...
<div class="container">
    <div class="row">
        ...
        <div class="col s12 m6 offset-m1">
            <h4 class="white-text">Super Admin Login</h4>
